...
export default function Contact() {
  return (
    <div className="fu">
      <div className="page-hdr"><h1><span className="gt">Liên hệ GV</span></h1></div>
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(min(300px,100%),1fr))',gap:'1.1rem',maxWidth:760}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'1rem'}}>
          <div className="card" style={{padding:'1.2rem'}}>
            <div style={{fontSize:'.65rem',color:'var(--txt3)',fontFamily:'var(--fm)',textTransform:'uppercase',letterSpacing:'.07em',marginBottom:'.6rem'}}>Môn học</div>
            <p style={{fontSize:'.85rem',color:'var(--txt2)',lineHeight:1.65}}>Bảo Mật Edge AI & Federated Learning — Chuyên đề nâng cao, Khoa CNTT, DH Da Lat</p>
          </div>
          <div className="alert ai" style={{margin:0,fontSize:'.83rem'}}>Email: Ghi rõ Họ Tên MSSV.</div>
          <div className="alert ap" style={{margin:0,fontSize:'.83rem'}}>NCKH: Liên hệ Giảng viên theo SĐT hoặc Email. Ưu tiên hướng Open Problem va Mới nổi.</div>
        </div>
      </div>
    </div>
  )
